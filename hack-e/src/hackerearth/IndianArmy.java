...
public class IndianArmy {
	...
	CheckPoint c=new IndianArmy.CheckPoint(parseLong(input[0])-parseLong(input[1]), parseLong(input[0])+parseLong(input[1]));
	minPQ.add(c);
	}
	return minPQ;
	}
//		//208451467498514314
	...
	System.out.println(IndianArmy.findMinimumDanger(minPQ, s, s, e));
	sc.close();
	}catch(Exception e){
	e.printStackTrace();
	}
